...
const StudyBackground = () => {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        {largeOrbs.map(orb => (
          <div
            ...
            style={{
              ...
              left: `${orb.left}%`,
              top: `${orb.top}%`,
              background: orb.color === 'blue' 
                ? 'radial-gradient(circle, hsl(210 100% 50%) 0%, transparent 70%)'
      ...
      <div className="absolute inset-0 bg-gradient-to-tl from-cyan-500/8 via-transparent to-blue-500/8" />
      <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/5 via-cyan-500/3 to-transparent" />
      <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-blue-500/6 via-cyan-500/3 to-transparent" />
      <div className="absolute bottom-0 right-0 w-full h-1/2 bg-gradient-to-t from-cyan-500/6 via-blue-500/3 to-transparent" />
