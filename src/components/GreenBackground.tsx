...
const GreenBackground = () => {
  ...
  const mediumParticles = useMemo(() => 
    Array.from({ length: Math.floor(18 * particleMultiplier) }, (_, i) => ({
      ...
      left: Math.random() * 100,
      top: Math.random() * 100,
      color: Math.random() > 0.5 ? 'green' : 'emerald',
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        {largeOrbs.map(orb => (
          <div
            ...
            style={{
              ...
              left: `${orb.left}%`,
              top: `${orb.top}%`,
              background: orb.color === 'green' 
                ? 'radial-gradient(circle, hsl(142 76% 50%) 0%, transparent 70%)'
                : 'radial-gradient(circle, hsl(160 84% 45%) 0%, transparent 70%)',
              opacity: orb.opacity,
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-green-500/8 via-transparent to-emerald-500/8" />
      <div className="absolute inset-0 bg-gradient-to-tl from-emerald-500/8 via-transparent to-green-500/8" />
      <div className="absolute inset-0 bg-gradient-to-tr from-green-500/5 via-emerald-500/3 to-transparent" />
      <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-emerald-500/6 via-green-500/3 to-transparent" />
      <div className="absolute bottom-0 right-0 w-full h-1/2 bg-gradient-to-t from-green-500/6 via-emerald-500/3 to-transparent" />
